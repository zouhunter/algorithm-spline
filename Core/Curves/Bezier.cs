...
namespace SplineCurve
{
    ...
    {
        public static Point CalculateBezierPoint(float t, params Point[] points) 
        {
            Point point = new Point(points[0].type);
        ...
        /// <param name="p3"></param>
        /// <returns></returns>
        public static float CalculateBezierPoint(float t, float p0, float p1, float p2, float p3)
        {
        ...
        /// <returns></returns>
        public static float CalculateBezierPoint(float t, params float[] points)
        {
            float point = 0;
            int n = points.Length - 1;
            for (int i = 0; i <= n; i++)
        ...
        /// <param name="points"></param>
        /// <returns></returns>
        public static Vector2 CalculateBezierPoint(float t, params Vector2[] points)
        {
